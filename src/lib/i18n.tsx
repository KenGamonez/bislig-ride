...
const en = {
  ...
  'install.close': 'Close',
  'install.installedNote': 'You are already using the installed app.',
  'install.unsupportedNote': 'To install, open your browser menu and choose Add to Home Screen or Install app.',
  ...
  'dash.title1': 'What do you need today?',
  'dash.subtitle': 'Choose a service to get started — fast, local, and reliable.',
  'dash.popular': 'Popular',
  'dash.rideNow': 'Ride Now',
  'dash.rideNowCopy': 'Get a ride around Bislig — quick pickup, fair fare.',
  'dash.otherWays': 'Other ways to move',
  'dash.pakyawan': 'Pakyawan',
  'dash.pakyawanDesc': 'Book a vehicle for longer trips or private use.',
  ...
  /* Transport section */
  'dash.transportLabel': 'MOVE AROUND THE CITY',
  'dash.transportTitle': 'Transport',
  'dash.transportSubtitle': 'Available now in Bislig City',
  /* Driver section */
  'dash.driverLabel': 'FOR DRIVERS',
  'dash.driverTitle': 'Drive with Hub',
  'dash.driverSubtitle': 'Earn on your own schedule',
  'dash.becomeDriver': 'Become a Driver',
  'dash.becomeDriverDesc': 'Apply once, drive for rides, pakyawan & delivery.',
  'dash.driverLogin': 'Driver Login',
  'dash.driverLoginDesc': 'Already driving? Open your dashboard.',
  ...
  'pak.timingNow': 'Now',
  'pak.timingScheduled': 'Scheduled',
  'pak.asapNote': 'Your trip will be requested immediately.',
  'pak.pastDateTime': 'Choose a future date and time.',
  ...
  'pad.timingNow': 'Now',
  'pad.timingScheduled': 'Scheduled',
  'pad.asapNote': 'Your delivery will be requested immediately.',
  'pad.pastDateTime': 'Choose a future date and time.',
  ...
  'pad.openChat': 'Open Chat',
  'pad.viewProof': 'View Proof',
  'pad.proofLoadFailed': 'Could not load the proof photo. Please try again.',
  'pad.rateTitle': 'Rate {name}',
  'pad.rateDriver': 'Rate your driver',
  'pad.ratePassenger': 'Rate your passenger',
  'pad.chatWithDriver': 'Chat with Driver',
  'pad.chatWithCustomer': 'Chat with Customer',
  ...
  'pad.cancelConfirmPrompt': 'Are you sure you want to cancel this delivery request?',
  'pad.confirmCancelYes': 'Yes, cancel it',
  'pad.keepBooking': 'Keep booking',
  'pad.cancelling': 'Cancelling...',
  'pad.cancelFailed': 'Could not cancel the delivery. Please try again.',
...
const bi: Record<TranslationKey, string> = {
  ...
  'install.close': 'Isira',
  'install.installedNote': 'Nagagamit na nimo ang naka-install nga app.',
  'install.unsupportedNote': 'Aron ma-install, ablihi ang menu sa imong browser ug pilia ang Add to Home Screen o Install app.',
  ...
  /* Homepage service dashboard */
  'dash.eyebrow': 'Bislig Hub',
  'dash.title1': 'Unsa ang imong kinahanglan karon?',
  'dash.subtitle': 'Pilia ang serbisyo aron makasugod — paspas, lokal, ug mapasaligan.',
  'dash.popular': 'Sikat',
  'dash.rideNow': 'Ride Now',
  'dash.rideNowCopy': 'Kuha og ride sa Bislig — paspas nga pag-kuha, tarong nga bayad.',
  'dash.otherWays': 'Uban pang paagi sa paglibot',
  'dash.pakyawan': 'Pakyawan',
  'dash.pakyawanDesc': 'Mag-book og sakyanan para sa layo nga byahe o pribado nga gamit.',
  'dash.paDeliver': 'Pa-deliver',
  'dash.paDeliverDesc': 'Magpadala og mga package sa tibuok Bislig.',
  ...
  /* Transport section */
  'dash.transportLabel': 'PADULONG SA DAKBAYAN',
  'dash.transportTitle': 'Transport',
  'dash.transportSubtitle': 'Available karon sa Bislig City',
  /* Driver section */
  'dash.driverLabel': 'PARA SA MGA DRIVER',
  'dash.driverTitle': 'Drive with Hub',
  'dash.driverSubtitle': 'Maka-income sa imong kaugalingong oras',
  'dash.becomeDriver': 'Mag-driver',
  'dash.becomeDriverDesc': 'Mag-apply usab, mag-drive para sa rides, pakyawan & delivery.',
  'dash.driverLogin': 'Driver Login',
  'dash.driverLoginDesc': 'Naga-drive na? Ibukas ang imong dashboard.',
  ...
  'pak.timingNow': 'Karon',
  'pak.timingScheduled': 'Naka-iskedyul',
  'pak.asapNote': 'Ang imong byahe pangayoon dayon.',
  'pak.pastDateTime': 'Pilia ang umaabot nga petsa ug oras.',
  ...
  'pad.timingNow': 'Karon',
  'pad.timingScheduled': 'Naka-iskedyul',
  'pad.asapNote': 'Ang imong delivery pangayoon dayon.',
  'pad.pastDateTime': 'Pilia ang umaabot nga petsa ug oras.',
  ...
  'pad.openChat': 'Ablihi ang Chat',
  'pad.viewProof': 'Tan-awa ang Pamatuod',
  'pad.proofLoadFailed': 'Dili ma-load ang litrato sa pamatuod. Palihog sulayi og balik.',
  'pad.rateTitle': 'I-rate si {name}',
  'pad.rateDriver': 'I-rate ang imong driver',
  'pad.ratePassenger': 'I-rate ang imong pasahero',
  'pad.chatWithDriver': 'Chat uban sa Driver',
  'pad.chatWithCustomer': 'Chat uban sa Customer',
  ...
  'pad.cancelConfirmPrompt': 'Sigurado ka ba nga gusto nimong i-cancel kini nga delivery request?',
  'pad.confirmCancelYes': 'Oo, i-cancel kini',
  'pad.keepBooking': 'Ipadayon ang booking',
  'pad.cancelling': 'Nag-cancel...',
  'pad.cancelFailed': 'Dili ma-cancel ang delivery. Palihog sulayi og balik.',
