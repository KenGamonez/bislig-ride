...
const en = {
  ...
  'pak.waitingDriverPrice': 'Your price will appear here once our driver reviews your request.',
  'pak.quoteReceived': 'Your driver sent the trip price. Review the details and confirm when you are ready.',
  'pak.newQuote': 'New quote',
  ...
  'pad.newUpdate': 'Delivery update',
  'pad.viewProof': 'View Proof',
  'pad.proofLoadFailed': 'Could not load the proof photo. Please try again.',
...
const bi: Record<TranslationKey, string> = {
  ...
  'pak.waitingDriverPrice': 'Mopakita diri ang imong presyo human ma-review sa among driver ang imong request.',
  'pak.quoteReceived': 'Gipadala na sa imong driver ang presyo sa byahe. Ribyuha ang mga detalye ug kumpirmahi kung andam na ka.',
  'pak.newQuote': 'Bag-ong quote',
  ...
  'pad.newUpdate': 'Update sa delivery',
  'pad.viewProof': 'Tan-awa ang Pamatuod',
  'pad.proofLoadFailed': 'Dili ma-load ang litrato sa pamatuod. Palihog sulayi og balik.',
